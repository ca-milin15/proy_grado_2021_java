...
public class RegistroController {
	...
	public RegistroBiometriaResponse registrarDatosBiometricos(@RequestPart MultipartFile fotografia){
		return registroService.registrarDatosBiometricos(fotografia);
	}
}
